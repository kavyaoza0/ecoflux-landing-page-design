...
const HeroSection = () => {
  ...
  return (
    <section id="hero" ref={ref} className="relative h-[100svh] flex items-center justify-center overflow-hidden">
      ...
      <motion.div style={{ y: textY, opacity: textOpacity }} className="relative z-20 text-center max-w-5xl mx-auto px-4 sm:px-6">
        <motion.p
          ...
          className="text-[10px] sm:text-xs md:text-sm tracking-[0.15em] sm:tracking-[0.3em] uppercase text-primary mb-4 sm:mb-6 md:mb-8 font-medium"
        >
          Smart Energy for a Better World
        </motion.p>

        <TextReveal delay={0.4}>
          <h1 className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-bold leading-[1.05] tracking-tight mb-4 sm:mb-6 md:mb-8">
            Powering a<br />
        ...
        <motion.p
          ...
          className="text-sm sm:text-base md:text-xl text-muted-foreground max-w-2xl mx-auto mb-6 sm:mb-8 md:mb-12 px-2"
        >
        ...
        >
          <MagneticButton strength={0.3}>
            <Button variant="hero" size="lg" className="text-sm sm:text-base px-6 sm:px-8 py-4 sm:py-6 w-full sm:w-auto">
              Power the Future
            </Button>
          </MagneticButton>
          <MagneticButton strength={0.2}>
            <Button variant="heroOutline" size="lg" className="text-sm sm:text-base px-6 sm:px-8 py-4 sm:py-6 w-full sm:w-auto">
              Learn More
            </Button>
          </MagneticButton>
        </motion.div>
